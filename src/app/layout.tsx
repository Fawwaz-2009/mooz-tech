...
export const metadata: Metadata = {
  ...
  description: "Fawwaz at Mooz Tech helps turn exciting ideas into real web projects. Professional web development services and solutions.",
  keywords: ["web development", "Mooz Tech", "Fawwaz", "web solutions", "software development"],
  authors: [{ name: "Fawwaz" }],
  creator: "Fawwaz",
  publisher: "Mooz Tech",
  robots: "index, follow",
