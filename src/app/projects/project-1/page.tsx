...
import { X, Sparkle, ArrowRight, ArrowLeft, House, Play } from 'lucide-react';
...
const Header = () => (
    <div className="flex w-full h-[259px] bg-[#F7F7F9] relative">
        ...
        <div className="max-w-[840px] w-full flex flex-col justify-end items-start gap-[96px] px-5 bottom-[30px] mx-auto pb-[19px] z-10">
            ...
            {/* Navigation */}
            <Link href="/projects" className='hover:cursor-pointer group/back'>
                <div className="flex flex-row gap-3 items-center">
                    <ArrowLeft className='w-6 h-6 stroke-[#757B80] group-hover/back:stroke-[#E29628]'/>
                    <p className='text-medium-1 font-regular text-[#707070] text-center group-hover/back:font-medium group-hover/back:text-[#E29628]'>All projects</p>
                </div>
            </Link>
            ...
            <div className="flex flex-row gap-3">
                ...
                <Link href="/projects" className='group/project-link'>
                    <p className='text-medium-1 font-regular text-[#707070] text-center group-hover/project-link:text-[#E29628] group-hover/project-link:font-medium'>Projects</p>
                </Link>
...
export default function Home() {
    return (
        <div className="relative">
            ...
            {/* Content */}
            <div className="mx-auto grid grid-cols-1 justify-center pt-[72px] pb-16 gap-y-[64px]">

                {/* Head */}
                <div className="flex flex-col gap-9 max-w-[840px] mx-auto px-5">
                ...
                <div className="flex flex-col gap-12">
                    ...
                    <div className='max-w-[1388px] mx-auto px-5'>
                        <img src="/project-display.png" alt="Image" />
                    </div>
                    ...
                    {/* Section-1 */}
                    <div className="flex flex-col max-w-[840px] mx-auto px-5">
                        <SectionTitle />
                        <Paragraph />
                        <ListDecimal />
                        <Paragraph />
            ...
            {/* Footer */}
            <div className="flex flex-col mx-auto grid-cols-1 justify-center px-4 pb-[96px] bg-[#F7F7F9]">
                <div className="flex justify-center max-w-[884px] mx-auto w-full border-b border-[#C6C6C7]">
                    <h6 className="uppercase font-sans text-big-5 text-[#7C7C7D] font-bold pt-[72px] pb-14">More Projects You'll Find Interesting</h6>
                </div>
                
                <div className="flex flex-col mx-auto gap-8">
                    <div className="mx-auto grid max-w-[884px] grid-cols-2 justify-center gap-x-[20px]">
                        <Card />
                        <Card />
                    </div>
                    ...
                    <Link href="/projects">
                        <div className="flex flex-row">
                            {/* Arrow */}
                            <div className="flex justify-center items-center w-[120px] h-full py-5 border-b border-t border-[#C6C6C7]">
                                <ArrowLeft className='h-10 w-10 stroke-1 opacity-40 stroke-[#0D1117]'/>
                            </div>
                            {/* Text */}
                            <div className="flex items-center px-8 border-b border-t border-[#C6C6C7] w-full">
                                <p className='text-medium-1 font-regular text-[#707070]'>All projects</p>
                            </div>
                        </div>
                    </Link>
                </div>
