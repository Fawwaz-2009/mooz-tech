      ...
      <Link href="/" className='cursor-pointer'>
        <div className="flex flex-col gap-[10px] px-5 pt-4 pb-[10px] bg-[#FEFEFE] rounded-small outline outline-1 outline-[#F0F0F0] shadow-sm">
          ...
          <div className="flex flex-row w-full justify-between items-center">
            ...
            <div className="group overflow-hidden flex items-center justify-center p-[5px] bg-[#ffffff] bg-opacity-50 rounded-full outline outline-2 outline-[#DEDEE0] transition transform duration-200 ease-in-out hover:bg-opacity-100 hover:outline-[3px]">
      ...
      <div className="w-full h-full min-h-[238px] bg-[#F7F7F9] relative">
        ...
        <div className="absolute flex flex-col top-3 left-6 gap-1">
          ...
          <div className='flex p-[10px] relative'>
            ...
            <div className="absolute w-full h-7 bg-[#F7F7F9] group-hover:animate-first-sentence"></div>
          </div>
          {/* Second sentence */}
          <div className="flex p-[10px] relative">
            <p className='text-dark-blue font-caveat text-[20px]'>the process of building product</p>
            <div className="absolute w-full h-7 bg-[#F7F7F9] group-hover:animate-second-sentence" style={{ animationDelay: "1900ms" }} ></div>
          </div>
          {/* Third-sentence */}
          <div className='flex p-[10px] relative'>
            <p className='text-dark-blue font-caveat text-[20px]'>Read anything that catches your interest.</p>
            <div className="absolute w-full h-7 bg-[#F7F7F9] group-hover:animate-third-sentence" style={{ animationDelay: "2600ms" }}></div>
          </div>
        </div>
        {/* Image */}
        <img src="/writings/hand.png" alt="Hand" className="absolute top-3 left-6 group-hover:animate-hand" />
        {/* Icon */}
        <div className="group/link absolute overflow-hidden bottom-4 left-4 p-2 flex items-center justify-center bg-[#ffffff] bg-opacity-50 rounded-full outline outline-2 outline-[#DEDEE0] z-20 transition transform duration-200 ease-in-out group-hover/link:bg-opacity-100 hover:outline-[3px]">
  ...
  <Link href="/projects" className='cursor-pointer'>
    <div className="group flex flex-col h-full outline outline-1 outline-[#DEDEE0] rounded-big overflow-clip">
      ...
      <div className="w-full h-full min-h-[571px] bg-white relative">
        {/* Icon */}
        <div className="group/icon absolute overflow-hidden bottom-4 left-4 p-2 flex items-center justify-center bg-[#ffffff] bg-opacity-50 rounded-full outline outline-2 outline-[#DEDEE0] z-20 transition transform duration-200 ease-in-out hover:bg-opacity-100 hover:outline-[3px]">
...
export default function Home() {
  return (
    <div className="">
      ...
      {/* Cards */}
      <div className="mx-auto grid max-w-[1368px] grid-cols-1 justify-center px-4 pt-[72px] pb-16">
